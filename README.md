...
- `app.js` — seeded 2‑D free‑energy landscape with an ensemble of particles under overdamped Langevin dynamics; each basin links somewhere, *measure* collapses the ensemble into one basin with probability equal to its occupancy
